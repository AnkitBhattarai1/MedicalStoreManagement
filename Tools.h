...
public:	
		System::Void static Lineargradientpaint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e, Rectangle rect, int r1, int g1, int b1, int r2, int g2, int b2, LinearGradientMode m) {
